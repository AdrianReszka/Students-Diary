...
public class StudentList {
     ...
     * @throws StudentNotFoundException    if the student with specified id was not found
     * @throws InvalidGradeValueException  if the grade has not a correct value
     * @throws InvalidGradeFormatException if the grade format is incorrect
     */
    public void addGradeToStudent(int studentId, String gradeInput, String teacher, String subject) throws InvalidGradeValueException, StudentNotFoundException, InvalidGradeFormatException {
        Student student = findStudentById(studentId);
        if (student == null) {
            throw new StudentNotFoundException();
        }
