...
public class MainMenuView {
    ...
    private JPanel createButtonPanel() {
        ...
        JButton removeGradeButton = new JButton("Remove student grade");
    ...
    private DefaultMutableTreeNode createStudentTreeNodes() {
        ...
        mainMenuController.getStudentList().getStudents().stream().sorted(Comparator.comparingInt(Student::getId)).forEach(student -> {
            DefaultMutableTreeNode studentNode = new DefaultMutableTreeNode(student.getId()+ ". " + student.getName() + " " + student.getSurname());
            ...
            student.getGrades().forEach(grade -> {
                ...
                DefaultMutableTreeNode gradeCategoryNode = new DefaultMutableTreeNode("Grade category: " + grade.getCategory());
                gradeNode.add(teacherNode);
                gradeNode.add(subjectNode);
                gradeNode.add(gradeCategoryNode);
            });
        });
        return root;
    }
